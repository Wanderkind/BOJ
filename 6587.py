...
def r8(n):o=7+(n//8)*16-n;p,q=v2(o),v4(o);r=v2(q);z=[o,p,q,r];return r4(n)*sum([r4(i)*f(n,i)for i in z])
def r16(n):A=15-n;B,C,E=v2(A),v4(A),7+(A//8)*16-A;D=v2(C);F,G=v2(E),v4(E);H=v2(G);z=[A,B,C,D,E,F,G,H];return r8(n)*sum([r8(i)*f(n,i)for i in z])
